          ...
          {menuOpen && (
            <nav style={dropdownMenuStyle}>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                <li><a href="/orders" style={dropdownLinkStyle}>Orders</a></li>
                <li><a href="/catalog" style={dropdownLinkStyle}>Catalog Products</a></li>
                <li><a href="/delivery-days" style={dropdownLinkStyle}>Delivery Days</a></li>
                <li><a href="/statistics" style={dropdownLinkStyle}>Statistics</a></li>
